...
unrealRootPath=/home/ohadanny/UnrealEngine
sixDOFRootPath=/home/ohadanny/Documents/Unreal Projects/sixDOF

gameProjectFile=/home/ohadanny/Documents/Unreal Projects/sixDOF/sixDOF.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(sixDOFSource.pri)
include(sixDOFHeader.pri)
include(sixDOFConfig.pri)
include(sixDOFIncludes.pri)
include(sixDOFDefines.pri)
...
sixDOF-Linux-Debug.commands = $$build sixDOF Linux Debug  -project="\"$$gameProjectFile\"" $$args
sixDOF-Linux-DebugGame.commands = $$build sixDOF Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
sixDOF-Linux-Shipping.commands = $$build sixDOF Linux Shipping  -project="\"$$gameProjectFile\"" $$args
sixDOF-Linux-Test.commands = $$build sixDOF Linux Test  -project="\"$$gameProjectFile\"" $$args
sixDOF.commands = $$build sixDOF Linux Development  -project="\"$$gameProjectFile\"" $$args

sixDOFEditor-Linux-Debug.commands = $$build sixDOFEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
sixDOFEditor-Linux-DebugGame.commands = $$build sixDOFEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
sixDOFEditor-Linux-Shipping.commands = $$build sixDOFEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
sixDOFEditor-Linux-Test.commands = $$build sixDOFEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
sixDOFEditor.commands = $$build sixDOFEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	sixDOF-Linux-Debug \
	sixDOF-Linux-DebugGame \
	sixDOF-Linux-Shipping \
	sixDOF-Linux-Test \
	sixDOF \
	sixDOFEditor-Linux-Debug \
	sixDOFEditor-Linux-DebugGame \
	sixDOFEditor-Linux-Shipping \
	sixDOFEditor-Linux-Test \
	sixDOFEditor \
