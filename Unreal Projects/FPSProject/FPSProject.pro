...
FPSProjectRootPath=/home/ohadanny/Documents/Unreal Projects/FPSProject

gameProjectFile=/home/ohadanny/Documents/Unreal Projects/FPSProject/FPSProject.uproject
...
FPSProject-Linux-Debug.commands = $$build FPSProject Linux Debug  -project="\"$$gameProjectFile\"" $$args
FPSProject-Linux-DebugGame.commands = $$build FPSProject Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FPSProject-Linux-Shipping.commands = $$build FPSProject Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FPSProject-Linux-Test.commands = $$build FPSProject Linux Test  -project="\"$$gameProjectFile\"" $$args
FPSProject.commands = $$build FPSProject Linux Development  -project="\"$$gameProjectFile\"" $$args

FPSProjectEditor-Linux-Debug.commands = $$build FPSProjectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
FPSProjectEditor-Linux-DebugGame.commands = $$build FPSProjectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FPSProjectEditor-Linux-Shipping.commands = $$build FPSProjectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FPSProjectEditor-Linux-Test.commands = $$build FPSProjectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
FPSProjectEditor.commands = $$build FPSProjectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
