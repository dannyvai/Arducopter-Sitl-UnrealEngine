...
parser.add_option("--utout", dest="utout",  help="UnrealEngine output (IP:port)", default="127.0.0.1:8888")
...
ut_out_address  = interpret_address(opts.utout)
...
# setup output to UnrealEngine
ut_out = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
#ut_out.connect(ut_out_address)
#ut_out.setblocking(0)
